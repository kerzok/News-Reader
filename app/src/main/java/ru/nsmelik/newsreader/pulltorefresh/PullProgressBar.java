 ...
 * trigger a refresh).
 */
public final class PullProgressBar {

    // Default progress animation colors are grays.
    private final static int COLOR1 = 0xFF1560BD;
    private final static int COLOR2 = 0xFFFF4300;
    private final static int COLOR3 = 0xFF177245;
    private final static int COLOR4 = 0xFFFDE910;
    ...
    public PullProgressBar(View parent) {
        mParent = parent;
        mColor1 = COLOR1;
        mColor2 = COLOR2;
        mColor3 = COLOR3;
    ...
    /**
     * Set the drawing bounds of this PullProgressBar.
     */
